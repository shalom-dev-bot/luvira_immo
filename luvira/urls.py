...
from properties.views import PropertyViewSet, ReviewViewSet  # ReviewViewSet ajouté
...
router.register(r'reviews', ReviewViewSet, basename='reviews')  # Avis

urlpatterns = [
    path('admin/', admin.site.urls),
    path('api/', include(router.urls)),
    path('api-auth/', include('rest_framework.urls')),  # Login DRF browser
